...
APPLICATION_FIELDS = (
    ...
    "department", "icon", "baseline_notes", "criticality", "support_hours", "expect_contains", "expect_absent", "hosted_on_server_id", "network_witness_server_id", "sla_target_percent", "site",
)
